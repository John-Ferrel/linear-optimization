...
def simplex_phase1(c,A,b):
    ...
    while 1:
        ...
        c_B[exits_order] = nc[enters_index]
        # print("c_B:",c_B,"b:",b)
        tmp_b = b[exits_order]/enters[exits_order]
        tmp_r = nA[exits_order,:] / enters[exits_order]
        # print(tmp_r,tmp_b)
        p1 = enters /enters[exits_order]
        b = b - b[exits_order] * p1
        nA = nA- nA[exits_order] * p1.reshape(m,1)
        # print(nA,b)
        b[exits_order] = tmp_b
        nA[exits_order,:] = tmp_r
...
def main():
    ...
    # process
    A,b,c_B,basis_index = simplex_phase1(c,matrixA,b)
